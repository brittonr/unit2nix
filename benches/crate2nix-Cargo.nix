...
#   "generate" "-f" "sample_workspace/Cargo.toml" "-o" "benches/crate2nix-Cargo.nix" "-h" "benches/crate2nix-hashes.json"
...
rec {
  ...
  workspaceMembers = {
    ...
    "sample-build-script" = rec {
      packageId = "sample-build-script";
      build = internal.buildRustCrateWithFeatures {
        packageId = "sample-build-script";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sample-bin" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../sample_workspace/sample-bin; };
        dependencies = [
          {
            name = "sample-build-script";
            packageId = "sample-build-script";
          }
          {
            name = "sample-lib";
      ...
      "sample-build-script" = rec {
        crateName = "sample-build-script";
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../sample_workspace/sample-build-script; };
        libName = "sample_build_script";

      };
      "sample-lib" = rec {
        crateName = "sample-lib";
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../sample_workspace/sample-lib; };
        libName = "sample_lib";
        dependencies = [
          {
            name = "serde";
      ...
      "sample-macro" = rec {
        crateName = "sample-macro";
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../sample_workspace/sample-macro; };
        procMacro = true;
        libName = "sample_macro";
